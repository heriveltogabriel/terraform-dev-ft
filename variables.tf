...
variable "container_repository_display_name_back" {
  default     = "backend"
  description = "Nome do repositório de container back-end"
}

variable "container_repository_display_name_front" {
  default     = "frontend"
  description = "Nome do repositório de container front-end"
}
